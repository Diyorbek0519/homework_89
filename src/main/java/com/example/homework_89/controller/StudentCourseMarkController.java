...
public class StudentCourseMarkController {
    ...
    public ResponseEntity<?> update2(@RequestBody StudentCourseMarkDTO studentCourseMarkDTO,
                                     @PathVariable("id") Integer id) {
        return ResponseEntity.ok(studentCourseMarkService.update2(studentCourseMarkDTO, id));
    }
